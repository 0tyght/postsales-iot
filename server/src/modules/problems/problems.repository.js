...
exports.create=async(d,userId)=>(await db.query(
 ...
 VALUES (?,?,?,?,?,?,?)`,[d.site_id,d.symptom_detail,'open',d.reported_at||new Date(),userId,d.source_type,d.contact_channel||channelFromSource(d.source_type)]
))[0].insertId;
exports.update=async(id,d)=>db.query(
 ...
 [d.site_id,d.symptom_detail,d.problem_status||'open',d.reported_at,d.source_type,d.contact_channel||channelFromSource(d.source_type),id]
);
