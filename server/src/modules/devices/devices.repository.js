...
exports.createUnit=async d=>(await db.query(
 ...
 [d.model_id,d.site_id,d.installation_job_id||null,d.serial_number,d.device_status||'active',d.purchase_date||null,d.warranty_years||null,warrantyEnd(d.purchase_date,d.warranty_years)]
))[0].insertId;
exports.updateUnit=async(id,d)=>db.query(
 ...
 [d.model_id,d.site_id,d.installation_job_id||null,d.serial_number,d.device_status||'active',d.purchase_date||null,d.warranty_years||null,warrantyEnd(d.purchase_date,d.warranty_years),id]
);
