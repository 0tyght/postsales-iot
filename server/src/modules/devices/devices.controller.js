...
exports.createModel=async(q,r)=>success(r,{model_id:await s.createModel(q.body)},'เพิ่มโมเดลแล้ว',201);
exports.updateModel=async(q,r)=>{await s.updateModel(q.params.id,q.body);success(r,null,'แก้ไขโมเดลแล้ว');};
exports.removeModel=async(q,r)=>{await s.removeModel(q.params.id);success(r,null,'ลบโมเดลแล้ว');};
