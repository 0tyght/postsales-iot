...
export default function ResourcePage({title,description,endpoint,idKey,columns,fields=[],lookups={},filters=[],readOnly=false,allowDelete=false,headerExtra,createLabel='เพิ่มข้อมูล',modalTitle='ข้อมูล',initialValues={},canDelete=()=>true,deleteBlockedMessage='รายการนี้ไม่สามารถลบได้ในสถานะปัจจุบัน',rowActions=[]}){
