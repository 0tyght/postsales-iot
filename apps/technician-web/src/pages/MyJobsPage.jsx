...
export default function MyJobsPage({jobs,onOpen,onCreate}){
 ...
 return <>
  <div className="page-title"><div><h1>งานของฉัน</h1><p>งานที่ฉันรับผิดชอบ กดเข้าไปเพื่อเริ่มงาน บันทึกอุปกรณ์ แนบรูป และปิดงาน</p></div><button className="primary compact" onClick={onCreate}>+ ติดตั้งจุดใหม่</button></div>
  <div className="tabs">
